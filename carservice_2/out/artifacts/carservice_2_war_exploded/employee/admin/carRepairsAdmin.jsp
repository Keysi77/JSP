        ...
        <div class="col-lg-12">
            <table class=" table table-bordered table-responsive">
                ...
                <tr>
                    ...
                    <td  ><a href="/employee/admin/updateRepairAdmin.jsp?id_repair=<%=repairs.get(
i).getId_repair()%>" class="btn btn-warning btn-lg"> <span class="glyphicon glyphicon-edit"></span> Edit</a>
                    ...
                    <td>
                        ...
                        <button  id="btnId_repair" class="btn btn-danger btn-lg" value="<%=repairs.get(i).getId_repair()%>">
